...
한국리스크관리에 재직하면서 해양진흥공사의 위기 관리 고도화 프로젝트를 진행한 적이 있습니다. 해당 프로젝트의 목적은 거시경제 변수들을 이용하여 이것이 유가변동에 어떠한 영향을 미치는지 분석하는 것이었습니다. 하지만 프로젝트 진행하던 당시, 해운 지수(index)의 데이터가 부족하여 구축한 통계 모델의 결과를 얻는 데 어려움을 겪은 적이 있습니다. 이를 해결하기 위해 Backcasting LSTM을 사용하여 부족한 과거 데이터의 index 값을 10분기 이상 확보하였습니다.

또한, 현재 회사에서 진행 중인 '위기인식지수 AI 고도화 프로젝트'에서는 데이터 불균형 문제가 있었습니다. 딥러닝 모델을 적용해 학습시키면 정확도는 높았으나 recall score가 매우 낮아지는 문제가 발생했습니다. 이를 해결하기 위해 SMOTE와 ADASYN 기법을 사용하여 주요 데이터의 0.5배만큼 데이터를 증강하였고, 이를 통해 딥러닝 모델의 성능을 향상시키는 데 성공했습니다. 이로써 정확도뿐만 아니라 recall score도 함께 높아졌습니다.

### **2. Deep Learning 관련 수강 과목을 나열해주세요.**

대학교 재학 당시 '통계적 딥러닝' 과목을 수강했습니다.

멀티캠퍼스 AI 서비스 개발자 교육과정에서는 파이썬, 빅데이터 분석, 머신러닝 및 딥러닝 교육을 받았습니다.

'학습계획서'

이후, AI 관련 저서를 검수함과 동시에 다양한 매체(유튜브 강의, 통계, 딥러닝/머신러닝 관련 저서)를 통해 머신러닝과 딥러닝에 대해 심도 있게 스스로 공부했습니다.

*이러한 공부를 거쳐가면서 다음과 같은 AI 관련 기술 스택을 보유할수 있게 되었습니다.*

- **프레임워크**: TensorFlow, PyTorch, Scikit-learn
- **사용 언어**: Python
- **데이터 전처리 및 시각화 라이브러리**: Matplotlib, Plotly, Seaborn, Pandas, NumPy, openCV

*다음의 머신러닝 및 딥러닝 지식을 습득할수 있었습니다.*

- **머신러닝/딥러닝**: KNN, 회귀분석, Naive Bayes, Decision Tree, SVM, PCA, Ensemble Learning, CNN, RNN 등
- **자연어 처리**: Transformer, BERT, GPT 등
- **XAI**: Global Explainer, LIME, SHAP 등
...
빠르게 업무에 적응하는 것이 우선입니다. 보고서 작성 과정에 참여하고, 필요한 데이터와 정보를 분석하여 전반적인 업무 구조와 프로젝트 흐름을 이해하겠습니다. 이를 통해 팀원들과 적극적으로 소통하며 업무 흐름을 신속하게 파악하여 맡은 직무에 빠르게 적응하겠습니다. 이러한 과정은 

**입사 3년 후**

회사의 허가 하에 야간 대학원에 진학하여 최신 AI 기술과 이론을 심도 있게 학습할 계획입니다. AI 기술은 빠르게 발전하고 있으며, 이론적인 발전이 실무에 적용될 때 큰 효과를 발휘한다고 믿습니다. 대학원에서 학습한 최신 AI 이론을 실무에 적용하여 회사의 AI 솔루션 개발을 선도하고자 합니다.

**입사 5년 후**

제가 속한 팀과 회사 전체가 시장에서 경쟁 우위를 점할 수 있는 혁신적인 AI 기반 솔루션을 개발하고 싶습니다. 대학원에서 배운 혁신적인 AI 기반 솔루션을 상품화하여 엔드유저에게 제공하는 것을 목표로 합니다. 이를 통해 제가 만든 솔루션이 사회의 많은 사람들에게 도움이 되는 것을 보고 싶습니다.
