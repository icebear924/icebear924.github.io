...
해양 진흥 공사 위기 관리 고도화 프로젝트 진행 중에 해운 지수(index)의 데이터가 부족한 현상이 있어서 조금 난항을 겪었는데, backcasting LSTM을 이용하여 부족한 과거 데이터 index값을 10분기 이상 확보함. 

## **2. Deep Learning 관련 수강 과목을 나열해주세요.**

대학교 다닐 당시 '통계적 딥러닝' 을 수강하였으며,

멀티캠퍼스 AI 서비스 개발자 교육과정에서는 파이썬, 빅데이터 분석, 머신러닝/딥러닝 교육을 받았음

이후, AI 관련 저서를 검수하는 동안 여러가지 매체를 통해서 머신러닝과 딥러닝에 대해서 심도 있는 공부를 하였음

- 위키독스에 있는 AI 관련 저서들을 공부
- 유튜브를 활용하여 공부
- 개인적으로도 딥러닝, 머신러닝, 통계 책을 구매하여 공부

--> 이러한 공부 내용들을 종합하면,  다음의 기술스택을 보유하고 있습니다.

 머신러닝 딥러닝 프레임 워크:

사용 언어

데이터 전처리 및 시각화 관련 라이브러리
...
일단 빠른 적응이 우선순위. 업무 관련 보고서나 업무의 흐름을 적극적인 자세로 빠르게 파악하여 나에게 주어진 직무에 최대한 무리없고 빠르게 스며들 예정. 제 단기적 목표는 회사에 입사하게 되면, 적극적으로 팀원들과 소통하면서 업무 흐름을 신속하게 파악하는 것입니다. 이를 위해 보고서 작성 과정에 참여하고, 각 업무에 필요한 데이터와 정보를 미리 분석하여 전반적인 업무 구조와 프로젝트의 흐름을 이해하고자 합니다. 

입사 3년 후

회사의 허가 하에 야간 대학원에 진학하여 최신 AI 기술과 이론을 심도있게 학습하는 것입니다. AI 기술은 빠르게 발전하고 있으며, 이론적인 발전이 실무에 적용될 때 가장 큰 효과를 발휘한다고 믿습니다. 따라서 대학원에서 학습한 최신 AI 이론을 실무에 적용하여 회사의 AI 솔루션 개발을 선도하고 싶습니다.

입사 5년 후

제가 속한 팀과 회사 전체가 시장에서 경쟁 우위를 점할 수 있는 혁신적인 AI 기반의 솔루션을 개발하고자 합니다. 대학원에서 배워서 적용한 혁신적인 AI 기반의 솔루션을 상품화 하여 엔드유저에게 제공하고 싶습니다. 제가 만든 솔루션이 사회의 많은 사람들에게 도움이 되는 것을 보고 싶습니다. 
